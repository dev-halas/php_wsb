				...
				<ul class="navbar-nav">
					<li class="nav-item pr-3">
						...
						<?php elseif(isset($_SESSION["adminId"])): ?>
							<a href="admin/dashboard.php" class="nav-link">Wróć do panelu</a>
						<?php endif; ?>
					</li>
					<li class="nav-item pr-3">
						...
						<?php else: ?>
							<a href="user/dashboard.php" class="nav-link">Wróć do panelu</a>
						<?php endif; ?>
					</li>
					<li class="nav-item pr-3">
						<?php if(!isset($_SESSION["customerID"])): ?>
						...
						<?php else: ?>
							<a href="user/logout.php" class="nav-link">Wyloguj</a>
						<?php endif; ?>
					</li>
				</ul>
		...
		<div class="container-fluid">
			...
			<?php if (!isset($_SESSION["customerID"])) : ?>
				<div class="col-12 text-center text-danger p-5">
					<h1>Zaloguj się do panelu aby dokonać rezerwacji... </h1>
